...
public class RobotContainer {
  ...
  public final Sensors m_Sensors = new Sensors(false, true, false);
  private final XboxController m_driverController = new XboxController(Controls.primaryController);
